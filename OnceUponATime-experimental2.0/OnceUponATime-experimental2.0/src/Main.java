...
public static void main() {
    ...
    List<Scenario> scenarios = loader.loadScenarios("C:\\Users\\zafeiro\\Pictures\\OnceUponATime-experimental2.0\\OnceUponATime-experimental2.0\\test2.xml");

    if (scenarios != null && !scenarios.isEmpty()) {
        playScenario(scenarios.getFirst());
    } else {
